...
dddcheck = pd.read_csv('train_dataall.csv')
...
# 定義模型訓練函數
def build_and_train_model(X, Y, X_val, y_true, X_test, output_filename='result_simple.csv'):
    model = Sequential()
    ...
    # Predict and save test set results
