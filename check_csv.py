...
df1 = pd.read_csv('gaussian_kernel/result3.csv')  # Replace with the path to your first CSV
df2 = pd.read_csv('result88.csv')  # Replace with the path to your second CSV
